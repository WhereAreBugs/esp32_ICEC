...
void DS1307Component::write_time() {
  ...
  this->write_rtc_();
    ...
    void DS1307Component::write_time(short year, byte month, byte day, byte hour, byte minute, byte second) {
        ds1307_.reg.year = (year - 2000) % 10;
        ds1307_.reg.year_10 = (year - 2000) / 10 % 10;
        ds1307_.reg.month = month % 10;
        ds1307_.reg.month_10 = month / 10;
        ds1307_.reg.day = day % 10;
        ds1307_.reg.day_10 = day / 10;
        ds1307_.reg.weekday = 0;
        ds1307_.reg.hour = hour % 10;
        ds1307_.reg.hour_10 = hour / 10;
        ds1307_.reg.minute = minute % 10;
        ds1307_.reg.minute_10 = minute / 10;
        ds1307_.reg.second = second % 10;
        ds1307_.reg.second_10 = second / 10;
        ds1307_.reg.ch = false;
    }
